...
exports.default = {
    ...
    afterEqual: function afterEqual(name) {
...
exports.default = {
  alpha: function alpha(name, value) {
    return new Promise(function (resolve, reject) {
      var re = /^[A-z]+$/;
      if (re.test(value)) resolve();
      var error = new Error(name + " field only allows alphabet");
      error.field = name;
      reject(error);
    });
  },
  alpha_dash: function alpha_dash(name, value) {
    return new Promise(function (resolve, reject) {
      var re = /^[a-zA-Z0-9-_]+$/;
      if (re.test(value)) resolve();
      var error = new Error(name + " field only allows alphabet, dash and underscore characters");
      error.field = name;
      reject(error);
    });
  },
  alpha_numeric: function alpha_numeric(name, value) {
    return new Promise(function (resolve, reject) {
      var re = /^[a-zA-Z0-9]*$/;
      if (re.test(value)) resolve();
      var error = new Error(name + " field must be alpha numeric");
      error.field = name;
      reject(error);
    });
  }
