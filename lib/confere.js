...
var _ValidatorError = __webpack_require__(19);
  ...
  (0, _createClass3.default)(ConfereJs, [{
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        var checkDone = function checkDone() {
          if (--remaining === 0) {
            ...
            if (typeof _this2.decorator === 'function') _this2.decorator(results, _this2.options.form, _this2.options);
          }
        };
    ...
    value: function validate(data) {
      ...
      (0, _keys2.default)(this.validators).map(function (validator) {
        ...
        validator = _this3.validators[validator]['validators'];
...
var _Confere = __webpack_require__(14);
...
exports.bootstrap4 = exports.bootstrap3 = undefined;
 ...
 * @returns {Element}
 */
var parent = function parent($element, $class) {
  while (($element = $element.parentElement) && !$element.classList.contains($class)) {}
  return $element;
};

var bootstrap3 = exports.bootstrap3 = function bootstrap3(results, $form) {
  var reset = function reset(element) {
    var group = formGroup(element);
    if (group) {
      (0, _map2.default)(group.getElementsByClassName('help-block'), function (element) {
        element.remove();
      });
    }
  };
  var success = function success(group, element) {
    group.classList.remove('has-error');
    group.classList.add('has-success');
  };

  var error = function error(group, element, result) {
  ...
  var formGroup = function formGroup(element) {
  ...
  (0, _keys2.default)(results).map(function (name) {
    error(formGroup($form.elements[name]), $form.elements[name], results[name]);
  });
};

var bootstrap4 = exports.bootstrap4 = function bootstrap4(results, $form) {
  var reset = function reset(element) {
    var group = formGroup(element);
    if (group) {
      (0, _map2.default)(group.getElementsByClassName('form-control-feedback'), function (element) {
        element.remove();
      });
    }
  };
  ...
  try {
    for (var _iterator2 = (0, _getIterator3.default)($form.elements), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
var $export = __webpack_require__(3)
  , $map    = __webpack_require__(124)(1);

$export($export.P + $export.F * !__webpack_require__(127)([].map, true), 'Array', {
