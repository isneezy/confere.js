...
var _ValidatorError = __webpack_require__(1);
  ...
  _createClass(ConfereJs, [{
    ...
    value: function validate(data) {
      ...
      Object.keys(this.validators).map(function (validator) {
        ...
        var validator = _this3.validators[validator]['validators'];
    ...
    value: function isEmpty(value) {
      ...
      try {
        for (var _iterator = emptyValues[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
var _Confere = __webpack_require__(0);
...
var bootstrap3 = exports.bootstrap3 = function bootstrap3(results, $form) {
  var reset = function reset(element) {
    ...
    if (group) {
      Array.map(group.getElementsByClassName('help-block'), function (element) {
        element.remove();
      });
    }
  };
...
var bootstrap4 = exports.bootstrap4 = function bootstrap4(results, $form) {
  var reset = function reset(element) {
    var group = formGroup(element);
    if (group) {
      Array.map(group.getElementsByClassName('form-control-feedback'), function (element) {
        element.remove();
      });
    }
  };
